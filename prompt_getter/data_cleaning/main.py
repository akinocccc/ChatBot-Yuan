...
from prompt_getter.data_cleaning.single_filter import main_filter, add_filter_args
from prompt_getter.data_cleaning.inputters.dataloaders import paths_dataloader
...
def main():
    ...
    parser.add_argument("--out_dir", type=str, default="D:/projects/ChatBot-Yuan/prompts/", help="Main data dir.")
    parser.add_argument("--dirty_dir", type=str, default="", help="Dir to save dirty cases.")
    parser.add_argument("--raw_dir", type=str, default="D:/projects/ChatBot-Yuan/prompt_getter/raw_data/", help="Dir of the raw dataset.")
